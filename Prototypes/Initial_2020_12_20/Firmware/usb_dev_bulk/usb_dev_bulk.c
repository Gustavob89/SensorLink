...
*/
    ...
    //for(loopCounter = 0; loopCounter < ui32Loop; loopCounter++){
     //   g_pui8USBTxBuffer[loopCounter] = 'a';
    //}
    ...
    char bufferTemp[10];
    sprintf(bufferTemp, "%d", ui32Value);

    //
    USBBufferWrite(&g_sTxBuffer, bufferTemp, 3);


    USBBufferDataWritten(&g_sTxBuffer, strlen(bufferTemp));
    USBBufferFlush(&g_sTxBuffer);
    return(strlen(bufferTemp));
}
